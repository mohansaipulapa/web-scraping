"""
Scraping all the posts of a Twitter account by infinite scrolling using selenium and BeautifulSoup
"""
...
# Variable that contains the profile our program will scrape
profile = 'Ryan Reynolds'
...
people = driver.find_element(By.XPATH,
    '//*[@id="react-root"]/div/div/div[2]/main/div/div/div/div[1]/div/div[1]/div[2]/nav/div/div[2]/div/div[3]/a/div').click()
time.sleep(2)

# clicks on our celebrities profile
profile = driver.find_element(By.XPATH,
    '//*[@id="react-root"]/div/div/div[2]/main/div/div/div/div[1]/div/div[2]/div/div/section/div/div/div[1]/div/div/div/div[2]/div[1]/div[1]/a/div/div[1]/div[1]/span').click()
time.sleep(2)
...
postings = soup.find_all('div',
                         class_='css-901oao r-18jsvk2 r-1qd0xha r-a023e6 r-16dba41 r-ad9z0x r-bcqeeo r-bnwqim r-qvutc0')
